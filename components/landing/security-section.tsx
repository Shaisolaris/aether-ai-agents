...
const securityFeatures = [
  {
    ...
    image: "/aether-ai-agents/images/isolated.jpg",
  },
  {
    icon: Lock,
    title: "Encrypted memory",
    description: "Data encrypted at rest and in transit.",
    image: "/aether-ai-agents/images/encrypted.jpg",
  },
  {
    icon: Eye,
    title: "Full audit trails",
    description: "Every action logged and inspectable.",
    image: "/aether-ai-agents/images/audit.jpg",
  },
  {
    icon: FileCheck,
    title: "Permission boundaries",
    description: "Principle of least privilege by design.",
    image: "/aether-ai-agents/images/permissions.jpg",
  },
];
